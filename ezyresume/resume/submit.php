...
<head>
  ...
  <title>
    <?php echo ucwords($first_name) . ' Resume'; ?>
  </title>
</head>

<body>

  <div class="grid-container prints">
    <div class="zone-1">
      <div class="toCenter">
    ...
    <div class="zone-2">
      <div class="headTitle">
        <h1>
          <?php echo ucwords($first_name); ?><br><b>
            <?php echo ucwords($last_name); ?>
          </b>
        </h1>
      </div>
      <div class="subTitle">
        <h1>
          <?php echo ucwords($profession); ?>
          <h1>
      </div>
      <div class="group-1">
        <div class="title">
...
< /style>
<div style="text-align: center; margin-top: -35px" class="print">
<button style="padding: 2px;font-size: 16px;;width: max-content; border-radius: 5px;" onclick="window.print();"><b>Looks Awesome... Save !!!</b></button>
</div>
